...
# Считываем стихотворение Винни-Пуха
...
#     return sum(1 for letter in word.lower() if letter in "аеёиоуыэюя")

# # Получаем список чисел слогов в каждой фразе
# syllables_counts = list(map(lambda phrase: count_syllables(phrase.replace('-', ' ')), phrases))

# # Проверяем, являются ли все числа слогов одинаковыми
# is_rhythm = all(count == syllables_counts[0] for count in syllables_counts)

# # Выводим результат в зависимости от флага ритма
# if is_rhythm:
#     print("Парам пам-пам")
# else:
#     print("Пам парам")
